...
// This file is responsible for rendering our 'React components' to the 'root div' in 'public/index.html'. 
// Aside from that, this is where will be using 'React Router' to route the 'React components'.
